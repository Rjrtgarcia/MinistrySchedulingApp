...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Join as a new volunteer' link to open the public registration form (element index 30).
        # link "Join as a new volunteer"
        elem = page.locator("xpath=/html/body/div[2]/div[2]/div[2]/a").nth(0)
        await elem.wait_for(state="visible", timeout=10000)
        await elem.click()
        
        # -> Fill the registration form with valid data, choose an area of interest, and submit the form (click index 586).
        # text input
        ...
        # -> Click the 'Submit Registration' button (index 586), wait for the UI to update, and verify a confirmation message indicating the application was received (search for text like 'application' or 'Thank you').
