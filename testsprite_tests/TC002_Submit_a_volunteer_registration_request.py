...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /register (http://localhost:3000/register) to reach the public applicant registration form.
        ...
        # -> Fill the contact details (first name, last name, email, phone), select two areas of interest, then submit the registration form.
        # text input
        ...
        # -> Select a second area of interest (Lighting Operator [338]) and submit the registration form (click Submit [449]). Then verify that a confirmation that the registration request was received is visible.
