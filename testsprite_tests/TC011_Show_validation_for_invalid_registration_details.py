...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Join as a new volunteer' link to open the registration form.
        # link "Join as a new volunteer"
        elem = page.locator("xpath=/html/body/div[2]/div[2]/div[2]/a").nth(0)
        await elem.wait_for(state="visible", timeout=10000)
        await elem.click()
        
        # -> Fill the First Name and Last Name with valid names, fill Email and Phone with invalid values, then click Submit Registration to trigger validation.
        # text input
