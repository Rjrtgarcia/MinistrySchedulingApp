...
async def run_test():
    ...
    try:
        ...
        # -> Open the registration form by clicking 'Join as a new volunteer'.
        # link "Join as a new volunteer"
        elem = page.locator("xpath=/html/body/div[2]/div[2]/div[2]/a").nth(0)
        await elem.wait_for(state="visible", timeout=10000)
        await elem.click()
        
        # -> Fill the registration form (first name, last name, email, phone), select areas of interest (Audio Engineer and Worship Leader), submit the form, then wait for and verify the confirmation message.
        # text input
        ...
        await elem.wait_for(state="visible", timeout=10000)
        await elem.fill("john.doe+volunteer@example.com")
        ...
        # -> Select 'Worship Leader' (index 185) and click 'Submit Registration' (index 200), then verify that a registration confirmation appears.
