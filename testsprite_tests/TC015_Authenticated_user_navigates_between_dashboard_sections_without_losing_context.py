...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Admin Role (Marcus)' Dev Bypass button to sign in as an admin and enter the protected area.
        # button "🔑 Admin Role (Marcus)"
        elem = page.locator("xpath=/html/body/div[2]/div[2]/div[2]/div[3]/div/button").nth(0)
        await elem.wait_for(state="visible", timeout=10000)
        await elem.click()
        
        # -> Navigate to /dashboard/events to open the events list in the authenticated area.
        ...
        # -> Click 'Schedule' in the left navigation to open the scheduling page (then verify navigation to Volunteers and back to Events).
        # link "Schedule"
