...
async def run_test():
    ...
    try:
        ...
        # -> Open the registration page by clicking 'Join as a new volunteer' so the registration form can be tested for required contact validation.
        # link "Join as a new volunteer"
        elem = page.locator("xpath=/html/body/div[2]/div[2]/div[2]/a").nth(0)
        await elem.wait_for(state="visible", timeout=10000)
        await elem.click()
        
        # -> Submit the registration form without entering any required fields to trigger validation feedback.
        # button "Submit Registration"
        elem = page.locator("xpath=/html/body/div[2]/div[2]/div[2]/form/button").nth(0)
        await elem.wait_for(state="visible", timeout=10000)
        await elem.click()
        
        # -> Fill the required contact fields (First Name, Last Name, Email) with valid values, then submit the registration form to verify successful confirmation appears.
        # text input
