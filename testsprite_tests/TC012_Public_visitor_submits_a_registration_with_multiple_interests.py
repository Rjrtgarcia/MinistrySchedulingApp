...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Join as a new volunteer' link to open the registration page.
        # link "Join as a new volunteer"
        elem = page.locator("xpath=/html/body/div[2]/div[2]/div[2]/a").nth(0)
        await elem.wait_for(state="visible", timeout=10000)
        await elem.click()
        
        # -> Fill the personal and contact fields, select multiple areas of interest, and submit the form.
        # text input
        ...
        # -> Select an additional area of interest (e.g., Lighting Operator) and submit the registration form, then verify a registration confirmation is displayed.
        ...
        # -> Click the 'Submit Registration' button (index 187) to submit the form, then wait for the page to show a confirmation message (e.g., 'Thank', 'Registration', or 'Confirmed').
        # button "Submit Registration"
        elem = page.locator("xpath=/html/body/div[2]/div[2]/div[2]/form/button").nth(0)
        await elem.wait_for(state="visible", timeout=10000)
        await elem.click()
